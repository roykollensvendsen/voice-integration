...
| a path argument goes into the URL, never into the body | 8 | `test_a_path_argument_goes_into_the_url_never_into_the_body` | yes |
...
| a delegation waits for the work rather than reading back a receipt | 2 | `test_a_delegation_waits_for_the_work_rather_than_reading_back_a_receipt` | yes |
